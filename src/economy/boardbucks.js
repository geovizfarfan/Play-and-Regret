...
const BEG_PAID = [
  ...
  (a, r) => `the universe felt bad for you today. **+${a} sins** <a:dice_roll:1507764402013868154> don't get used to it.`,
  ...
  (a, r) => `you asked. it worked. don't analyze it. **+${a} sins** <a:dice_roll:1507764402013868154>`,
...
const BEG_JACKPOT = [
  ...
  (a, r) => `rare pity event triggered. **+${a} sins** <a:dice_roll:1507764402013868154> **+${r} regret**. you won but you lost.`,
...
const DAILY_MESSAGES = [
  ...
  (a) => `<a:SINS:1522338223613804724> Your daily allowance from the chaos treasury: **${a} sins**`,
  ...
  (a) => `<a:SINS:1522338223613804724> Spend this wisely. (You won't.) **+${a} sins**`,
  ...
  (a) => `<a:SINS:1522338223613804724> Today's allowance for irresponsible gambling. **${a} sins** — go forth.`,
...
module.exports = {
  ...
  async give(message, args) {
    ...
    return message.reply({ embeds: [
      new EmbedBuilder().setColor('#D8B4FE')
        .setTitle('<a:SINS:1522338223613804724> Sins Transfer')
        .setDescription(
  ...
  async executeGive(senderId, targetId, amount, replyFn, client) {
    ...
    return replyFn({ embeds: [
      new EmbedBuilder().setColor('#D8B4FE')
        .setTitle('<a:SINS:1522338223613804724> Sins Given!')
        .setDescription(
  ...
  async drop(message, args) {
    ...
    const dropMsg = await message.channel.send({ embeds: [
      new EmbedBuilder().setColor('#D8B4FE')
        .setTitle('<a:SINS:1522338223613804724> sins DROP!')
  ...
  async taxcalc(message, args) {
    ...
    const reply = await message.reply({ embeds: [
      new EmbedBuilder().setColor('#C9B1FF')
        .setTitle('<a:SINS:1522338223613804724> Tax Calculator')
        .setDescription(
  ...
  async guide(message) {
    const embeds = [
      ...
      new EmbedBuilder().setColor('#D8B4FE')
        ...
        .addFields(
          { name: '<a:SINS:1522338223613804724> Sins', value: 'The server currency. Earn them, spend them, give them, lose them.', inline: true },
      ...
      // Economy
      new EmbedBuilder().setColor('#D8B4FE')
        .setTitle('<a:SINS:1522338223613804724> Economy Commands')
        .addFields(
  ...
  async profile(message, args) {
    ...
    return message.reply({ embeds: [
      new EmbedBuilder().setColor('#C9B1FF')
        ...
        .addFields(
          { name: '<a:SINS:1522338223613804724> Balance',    value: `${bal.toLocaleString()} sins`,                    inline: true },
