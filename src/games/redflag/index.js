...
async function handleLobbyButton(interaction) {
  ...
  if (action === 'rf_join') {
    ...
    return interaction.reply({ content: `<:checkmark:1495666088417956002> You're in${game.feeEnabled ? ` — **${game.feeAmount.toLocaleString()} sins** paid` : ''}. Try not to collect flags.`, ephemeral: true });
  }
